...
var user_service_mongodb_1 = __importDefault(require("../services/user.service-mongodb"));
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.findByMail(email)];
            case 1:
                user = _b.sent();
                if (!user) {
            ...
            case 2:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.generateAccessToken(user.email)];
            case 3:
                token = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.findByUsername(username)];
            case 2:
            ...
            case 4:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.createUser(username, email, hashedPassword)];
            case 5:
...
router.delete("/api/users/delete", user_service_mongodb_1.default.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.deleteUser(id)];
            case 1:
...
router.get("/api/users/current", user_service_mongodb_1.default.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.findByID(id)];
            case 1:
                currentUser = _a.sent();
                if (!currentUser) {
...
router.patch("/api/users/update/name", user_service_mongodb_1.default.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.updateName(name_1, id)];
            case 1:
...
router.patch("/api/users/update/username", user_service_mongodb_1.default.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.updateUsername(username, id)];
            case 2:
                updateSuccess = _a.sent();
                if (!updateSuccess) {
                    return [2 /*return*/, res.status(400).json({
...
router.patch("/api/users/update/institution", user_service_mongodb_1.default.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.updateInstitution(institution, id)];
            case 1:
                updateSuccess = _a.sent();
                if (!updateSuccess) {
                    return [2 /*return*/, res.status(400).json({
...
router.patch("/api/users/update/email", user_service_mongodb_1.default.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.findByMail(newMail)];
            case 1:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.updateMail(newMail, id)];
            case 2:
                updateSuccess = _a.sent();
                if (!updateSuccess) {
                    return [2 /*return*/, res.status(400).json({
...
router.patch("/api/users/update/password", user_service_mongodb_1.default.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, user_service_mongodb_1.default.updatePassword(newHashedPass, id)];
            case 4:
...
router.post("/api/users/authpass", user_service_mongodb_1.default.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
router.post("/api/users/authtoken", user_service_mongodb_1.default.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id;
    return __generator(this, function (_a) {
        try {
            id = req.userId;
...
router.post("/api/users/update/img", user_service_mongodb_1.default.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                updateSuccess = user_service_mongodb_1.default.updateImgUrl(imgurl, id);
                if (!updateSuccess) {
                    return [2 /*return*/, res.status(400).json({
